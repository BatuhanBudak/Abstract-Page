...
export default function Header() {
    const { headerClassName, searchToggled, navToggled, toggleSearch,
        closeNav,
        toggleNav } = useChangeClassName()
            ...
            <div className='mobile-search-container' id="mobile-search" >
                <div className='mobile-search-container-inner'>
                    <form className="mobile-search-form">
                        ...
                        <button
                            onClick={e => (toggleSearch(e))}
                            className="search-close-button btn"> <Image className="close-svg" src='/close.svg' width={24} height={24} alt="search icon" /></button>
                    </form>
                </div>
            </div>
